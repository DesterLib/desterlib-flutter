...
class ScanApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1ScanCleanupPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1ScanCleanupPost200Response>> apiV1ScanCleanupPost({ 
    ...
    final _path = r'/api/v1/scan/cleanup';
    ...
    ApiV1ScanCleanupPost200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1ScanCleanupPost200Response),
      ) as ApiV1ScanCleanupPost200Response;
    ...
    return Response<ApiV1ScanCleanupPost200Response>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1ScanJobScanJobIdGet({ 
    ...
    final _path = r'/api/v1/scan/job/{scanJobId}'.replaceAll('{' r'scanJobId' '}', encodeQueryParameter(_serializers, scanJobId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [scanJobId] - The ID of the scan job to resume
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1ScanResumeScanJobIdPost202Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1ScanResumeScanJobIdPost202Response>> apiV1ScanResumeScanJobIdPost({ 
    required String scanJobId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/scan/resume/{scanJobId}'.replaceAll('{' r'scanJobId' '}', encodeQueryParameter(_serializers, scanJobId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiV1ScanResumeScanJobIdPost202Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1ScanResumeScanJobIdPost202Response),
      ) as ApiV1ScanResumeScanJobIdPost202Response;
    ...
    return Response<ApiV1ScanResumeScanJobIdPost202Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
