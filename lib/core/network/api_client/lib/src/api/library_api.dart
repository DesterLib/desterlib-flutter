...
class LibraryApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1LibraryDelete200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1LibraryDelete200Response>> apiV1LibraryDelete({ 
    required ApiV1LibraryDeleteRequest apiV1LibraryDeleteRequest,
    ...
    try {
      const _type = FullType(ApiV1LibraryDeleteRequest);
      _bodyData = _serializers.serialize(apiV1LibraryDeleteRequest, specifiedType: _type);
    ...
    ApiV1LibraryDelete200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1LibraryDelete200Response),
      ) as ApiV1LibraryDelete200Response;
    ...
    return Response<ApiV1LibraryDelete200Response>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [isLibrary] - Filter by actual libraries (true) vs collections (false)
  /// * [libraryType] - Filter by library media type
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ApiV1LibraryGet200Response>> apiV1LibraryGet({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (isLibrary != null) r'isLibrary': encodeQueryParameter(_serializers, isLibrary, const FullType(bool)),
      if (libraryType != null) r'libraryType': encodeQueryParameter(_serializers, libraryType, const FullType(String)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1LibraryPut200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1LibraryPut200Response>> apiV1LibraryPut({ 
    required ApiV1LibraryPutRequest apiV1LibraryPutRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ApiV1LibraryPutRequest);
      _bodyData = _serializers.serialize(apiV1LibraryPutRequest, specifiedType: _type);
    ...
    ApiV1LibraryPut200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1LibraryPut200Response),
      ) as ApiV1LibraryPut200Response;
    ...
    return Response<ApiV1LibraryPut200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
