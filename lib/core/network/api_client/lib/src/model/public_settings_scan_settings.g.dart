...
part of 'public_settings_scan_settings.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const PublicSettingsScanSettingsMediaTypeEnum
_$publicSettingsScanSettingsMediaTypeEnum_movie =
    const PublicSettingsScanSettingsMediaTypeEnum._('movie');
const PublicSettingsScanSettingsMediaTypeEnum
_$publicSettingsScanSettingsMediaTypeEnum_tv =
    const PublicSettingsScanSettingsMediaTypeEnum._('tv');

PublicSettingsScanSettingsMediaTypeEnum
_$publicSettingsScanSettingsMediaTypeEnumValueOf(String name) {
  switch (name) {
    case 'movie':
      return _$publicSettingsScanSettingsMediaTypeEnum_movie;
    case 'tv':
      return _$publicSettingsScanSettingsMediaTypeEnum_tv;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<PublicSettingsScanSettingsMediaTypeEnum>
_$publicSettingsScanSettingsMediaTypeEnumValues =
    BuiltSet<PublicSettingsScanSettingsMediaTypeEnum>(
      const <PublicSettingsScanSettingsMediaTypeEnum>[
        _$publicSettingsScanSettingsMediaTypeEnum_movie,
        _$publicSettingsScanSettingsMediaTypeEnum_tv,
      ],
...
Serializer<PublicSettingsScanSettingsMediaTypeEnum>
_$publicSettingsScanSettingsMediaTypeEnumSerializer =
    _$PublicSettingsScanSettingsMediaTypeEnumSerializer();

class _$PublicSettingsScanSettingsMediaTypeEnumSerializer
    implements PrimitiveSerializer<PublicSettingsScanSettingsMediaTypeEnum> {
  ...
  @override
  final String wireName = 'PublicSettingsScanSettingsMediaTypeEnum';

  @override
  Object serialize(
    Serializers serializers,
    PublicSettingsScanSettingsMediaTypeEnum object, {
    FullType specifiedType = FullType.unspecified,
  }) => _toWire[object.name] ?? object.name;

  @override
  PublicSettingsScanSettingsMediaTypeEnum deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) => PublicSettingsScanSettingsMediaTypeEnum.valueOf(
    _fromWire[serialized] ?? (serialized is String ? serialized : ''),
  );
}

class _$PublicSettingsScanSettings extends PublicSettingsScanSettings {
  @override
  final PublicSettingsScanSettingsMediaTypeEnum? mediaType;
  @override
  final num? maxDepth;
  @override
  ...
  factory _$PublicSettingsScanSettings([
    void Function(PublicSettingsScanSettingsBuilder)? updates,
  ]) => (PublicSettingsScanSettingsBuilder()..update(updates))._build();

  _$PublicSettingsScanSettings._({
    this.mediaType,
    this.maxDepth,
    this.mediaTypeDepth,
    this.fileExtensions,
  ...
  @override
  PublicSettingsScanSettings rebuild(
    void Function(PublicSettingsScanSettingsBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  PublicSettingsScanSettingsBuilder toBuilder() =>
      PublicSettingsScanSettingsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PublicSettingsScanSettings &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PublicSettingsScanSettings')
...
class PublicSettingsScanSettingsBuilder
    implements
        Builder<PublicSettingsScanSettings, PublicSettingsScanSettingsBuilder> {
  _$PublicSettingsScanSettings? _$v;

  PublicSettingsScanSettingsMediaTypeEnum? _mediaType;
  PublicSettingsScanSettingsMediaTypeEnum? get mediaType => _$this._mediaType;
  set mediaType(PublicSettingsScanSettingsMediaTypeEnum? mediaType) =>
  ...
  PublicSettingsScanSettingsBuilder() {
    PublicSettingsScanSettings._defaults(this);
  }

  PublicSettingsScanSettingsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PublicSettingsScanSettings other) {
    _$v = other as _$PublicSettingsScanSettings;
  }

  @override
  void update(void Function(PublicSettingsScanSettingsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PublicSettingsScanSettings build() => _build();

  _$PublicSettingsScanSettings _build() {
    _$PublicSettingsScanSettings _$result;
    try {
      _$result =
          _$v ??
          _$PublicSettingsScanSettings._(
