...
class DSettingsSlider extends StatefulWidget {
  final double value;
  final double min;
  final double max;
  final int? divisions;
  ...
  @override
  State<DSettingsSlider> createState() => _DSettingsSliderState();
}

class _DSettingsSliderState extends State<DSettingsSlider> {
  ...
  @override
  void didUpdateWidget(DSettingsSlider oldWidget) {
