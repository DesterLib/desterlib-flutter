...
/// Screen for managing TV show-specific scan settings
class TvScanSettingsScreen extends ConsumerStatefulWidget {
  const TvScanSettingsScreen({super.key});

  @override
  ConsumerState<TvScanSettingsScreen> createState() =>
      _TvScanSettingsScreenState();
}

class _TvScanSettingsScreenState extends ConsumerState<TvScanSettingsScreen>
  ...
  Widget _buildContent(BuildContext context) {
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          DAppBar(
            title: AppLocalization.settingsScanTvShowSpecificSettings.tr(),
            isCompact: true,
          ),
          SliverPadding(
                        ...
                        group: SettingsGroup(
                          ...
                          children: [
                            FormBuilderField<double>(
                              name: 'tvDepth',
                              initialValue:
                                  _scanSettings.tvDepth?.toDouble() ?? 0.0,
