...
class SearchApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1SearchGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1SearchGet200Response>> apiV1SearchGet({ 
    ...
    ApiV1SearchGet200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1SearchGet200Response),
      ) as ApiV1SearchGet200Response;
    ...
    return Response<ApiV1SearchGet200Response>(
      data: _responseData,
